...
//should fix this test after precise go change from unit64 compacts to byte compacts
...
//    });
    ...
    let compactProperty = [0,0,0,2,  0,0,0x02,0x01,  0,0,0,2,   0,0,0,2,  0,0,0,4,  0,0,0,5,  0,0,0,2];
    ...
    let literalForBytesMap='itemMap2[0x0000000000abbccd].name';
    let compactPropertyForBytesMap = [0,0,0,4,  0,0,0,0,0,0xab,0xbc,0xcd, 0,0,0,1];
    ...
    let compactPropertyForInt64Map = [0x0,0,0,6,  0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xEE,0x29,  0,0,0,1];

    let literalWithImport = 'items[513].items[2].cents[5].value.name';
    let compactPropertyWithImport = [0,0,0,2,  0x00,0x00,0x02,0x01,  0,0,0,2,  0,0,0,2,  0,0,0,4,  0,0,0,5,  0,0,0,3,  0,0,0,1];
    ...
    let errorCompactProperty1 = [0,0,0,8,  0,0,0x02,0x01,  0,0,0,2,   0,0,0,2,  0,0,0,4,   0,0,0,5,   0,0,0,2];
    let errorCompactProperty2 = [0,0,0,2,  0,0,0x02,0x01,  0,0,0,2,   0,0,0,2,  0,0,0,4,   0,0,0,5,   0,0,0,4];
